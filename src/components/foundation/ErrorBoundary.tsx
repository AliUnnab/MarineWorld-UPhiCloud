          ...
          <div className="max-w-2xl w-full bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl space-y-6">
            ...
            <div className="flex items-center gap-3 pt-2 border-t border-slate-800">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-royal hover:bg-royal-light text-white font-semibold text-sm transition shadow-lg shadow-royal/20 cursor-pointer"
              >
